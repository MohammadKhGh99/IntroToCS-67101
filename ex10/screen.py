...
class ShapesMaster:
    ...
    ASTEROID_1_LAYOUT = (
    (-10, -5), (-12, 0), (-8, 8), (0, 13), (8, 6), (14, 0), (12, 0), (8, -6),
    (0, -7))
    ...
    def __init__(self, screen):
        ...
        controlling the game, you should not call this method anywhere in your
        code.
        """
        self.screen = screen
        self._shapes = {}
...
class Screen:
    ...
    def _init_graphics(self):
        ...
        # livesScreen.register_shape(ShapesMaster.SHIP_SHAPE, shapes[
        # ShapesMaster.SHIP_SHAPE])
        ...
        life1 = self._get_ship_obj(livesCanvas)  # SpaceShip(livesCanvas,
        # -35,0,0,0)
    ...
    def ontimer(self, func, milli):
        ...
        :param func: The function to repeat after **milli** milliseconds have
        passed
        :type func: function
        :param milli: The amount of milliseconds to wait before starting the
        given function
        :type milli: int
        """
    ...
    def start_screen(self):
        """
        This is called to start our game (graphics-wise).
    ...
    def draw_asteroid(self, asteroid, x, y):
        ...
        :param asteroid: This is your asteroid object (remember to register
        it before)
        :type asteroid: Asteroid
